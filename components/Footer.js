...
const Footer = () => {
  return (
    <>
      <footer className="container text-white bg-primary body-font max-w-9xl mx-auto px-10">
        <div className="container px-5 py-20 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-76 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            ...
            <ul class="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
              <li>
                <a
                  ...
                  target="_blank"
                  class="text-white transition hover:text-green-200"
                >
